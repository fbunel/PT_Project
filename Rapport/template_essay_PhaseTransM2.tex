...
\title{{\normalsize Master M2 Sciences de la Mati\`ere -- ENS de Lyon --  2016-2017} \\
{\normalsize \emph{Phase Transitions and Critical Phenomena}} \\ 
\bigskip
\bigskip
\bigskip
{\bf Transition nématique-isotrope \\ dans le modèle de Lebwohl-Lasher}}
...
\textbf{Mots clefs :} nématique, modèle de Lebwohl-Lasher, Monte-Carlo.

\begin{center}
\includegraphics[height=8.5cm]{figures/cristaux_liquides.png} 
\end{center}}
