...
def figure(filename):
    ...
    ax2.plot(cycle, order,
        linewidth = 2,
        color = 'g')
    ax1.plot(cycle, energie, 
        linewidth = 2,
        color = 'b')
    ...
    ax2.set_ylabel(r"$S$", fontsize = 22, color = 'g')
    ax1.set_xlabel(r"Cycle", fontsize = 22)
    ax1.set_ylabel(r"$E^\star$", fontsize = 22, color = 'b')
