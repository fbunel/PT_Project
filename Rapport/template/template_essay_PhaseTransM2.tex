%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                %
%   Enonce des TDs "Transitions de Phase et Brisure de Symetrie  %
%                                                                %
%          M 2, 2006/2007,2007/2008,2008/2009 Peter Holdsworth                      %
%                          Christophe Winisdoerffer              %
%                                                                %
%   Attention: 1ere moitie du document : enonces en francais     %
%              2eme moitie du document : enonces en anglais      %
%                                                                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%% definitions %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[11pt]{article}
\usepackage{epsf,epsfig,wrapfig}
\usepackage{graphicx}
...
\title{{\normalsize Master M2 Sciences de la Mati\`ere -- ENS de Lyon --  2015-2016} \\
{\normalsize \emph{Phase Transitions and Critical Phenomena}} \\ 
\bigskip
\bigskip
\bigskip
{\bf Essay on your subject of choice}}
\author{Your name}

\maketitle

\abstract{Here goes a short summary of your essay, containing a statement of the physical problem, the methods used and the main results.}
...
Les simulations reportées dans ce rapport ont toutes été réalisées sur un réseau cubique de taille $30\times 30\times 30$ avec des conditions aux limites périodiques. Elles sont commencées depuis l'état fondamental où toutes les molécules sont alignées. Lorsque l'on démarre la simulation, les molécules sont bougées les unes après les autres en utilisant l'algorithme de Monte-Carlo. On nomme "cycle" une suite de $30\times 30\times 30$ mouvements. Durant un cycle, toutes les molécules du réseau sont bougées exactement une fois mais dans un ordre aléatoire. Une telle procédure assure que toutes les molécules ont la même chance d'être bougée en réduisant les irrégularités dues à un tirage totalement aléatoire \cite{fabbri}. 
\medskip

Pour chaque température, au minimum 1000 cycles sont calculés pour faire évoluer le système vers la configuration d'équilibre. Les variations de l'énergie et du paramètre d'ordre permettent de vérifier que le système est bien à l'équilibre. Ensuite, jusqu'à 25000 cycles sont réalisés afin de calculer les quantités d'intérêts.
