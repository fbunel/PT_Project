...
\begin{figure}[h!]
    ...
    \end{tikzpicture}  
\caption{Schéma de fonctionnement d'un pixel d'un écran LCD}
        \label{freedericksz} 
\end{figure}
...
TO DO LIST
\begin{itemize}
\item Changer la figure de fonctionnement en deux figures et citer le bouquin d'oswald dans la légende
\item Coder LCD
