...
def figure(basename, skiprow, outputname):
    ...
    print(np.std(TrDeltaEn))
    print(TrDeltaEn)

    print("Delta Ordre")
    print(np.mean(TrDeltaOr))
    print(np.std(TrDeltaOr))
    print(TrDeltaOr)
    print("Derivée Energie")
    print(np.mean(TrDiffEn))
    print(np.std(TrDiffEn))
    print(TrDiffEn)
    print("Derivée Ordre")
    print(np.mean(TrDiffOr))
    print(np.std(TrDiffOr))
    print(TrDiffOr)
...
# figure('electricField/006/**/*study.save', 4, 'electric006')
# figure('electricField/007/**/*study.save', 4, 'electric007')
# figure('electricField/008/**/*study.save', 4, 'electric008')
# figure('electricField/009/**/*study.save', 4, 'electric009')
