...
\begin{figure}[h]
    ...
    \caption{Équilibrage du système à une température $T^\star = k_B T/\epsilon = 1$ en partant de l'état fondamental. La remise à l'échelle de l'échelle énergétique est détaillé en partie \ref{scale}.}
    	\label{equilibrage} 
\end{figure}
...
Une première méthode pour observer la transition de phase est d'afficher directement les
